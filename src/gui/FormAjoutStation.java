 ...
 * @author houss
 */
public class FormAjoutStation extends Form{
    public FormAjoutStation(Form previous){
...
//        
        ...
        TextField tfName3 = new TextField("","nombre de vélos");
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                else
                {
                    try {
                        ...
                        {
                           Dialog.show("Success","Station ajoutee",new Command("OK"));
                        }else
